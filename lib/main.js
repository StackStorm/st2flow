...
import ControlGroup from './panels/controlgroup';
import Editor from './editor';
import ExecutionControl from './panels/executioncontrol';
import CatchControl from './panels/catchcontrol';
...
class Main extends React.Component {
    ...
    return <main {...props} >
      <div className="st2-header">
        <div className="st2-header__logo">
          <img src="i/logo-extreme.svg" width="101" height="25" />
        </div>
  ...
  showRun() {
    return Promise.resolve()
      ...
      .then(() => {
        return this.refs.runPopup.show();
      })
  }
    ...
    return Promise.resolve()
      .then(() => {
        if (_.isEmpty(this.state.action)) {
          return this.refs.metaPopup.show(true);
        } else {
          return this.state.action;
        }
      })
      .then(actionMeta => {
        return _.assign({}, actionMeta, {
          data_files: [{
